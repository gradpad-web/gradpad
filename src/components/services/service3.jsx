...
const Service3 = () => {
  return (
    <div className="lg:max-w-5xl xl:max-w-7xl mx-auto px-3 py-10">
      <h1 className='text-2xl md:text-4xl font-semibold capitalize mb-3 sm:mb-5 dark:text-white md:px-3'>Service3</h1>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 lg:gap-20'>
        ...
        <div className='md:px-3'>
          <img className='w-full rounded-xl' src='https://assets.aceternity.com/demos/Screenshot+2024-02-21+at+11.51.31%E2%80%AFPM.png' alt='service 3 name' />
        </div>
      </div>
    </div>
  )
