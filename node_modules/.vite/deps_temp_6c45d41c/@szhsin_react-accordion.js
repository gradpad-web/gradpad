...
var initialStateMap = /* @__PURE__ */ new Map();
var initialConfigMap = /* @__PURE__ */ new Map();
...
var useTransitionMap = ({
  ...
  const [stateMap, setStateMap] = (0, import_react2.useState)(initialStateMap);
  const latestStateMap = (0, import_react2.useRef)(stateMap);
  const configMap = (0, import_react2.useRef)(initialConfigMap);
